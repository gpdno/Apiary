...
namespace Alveo.UserCode
{
    [Serializable]
    [Description("")]
    public class HMA_EA : ExpertAdvisorBase   // **Expert Advisor Class name must be the same as the filename
    {
        ...
        public HMA_EA()      // Class constuctor, called by Alveo
        {
        ...
        public HMA_EA(bool optimizing, DateTime time, string path) : this()  // constructor called by simulation
        {
            simulate = true;
            optimize = optimizing;
            simTime = time;
        ...
        internal class HMAobj
        {
            ...
            internal HMAobj(HMA_EA ea, int period, int threshold) : this()   // do HEMA() first
            {
                this.ea = ea;
                Period = period;
