...
namespace Alveo.UserCode
{
    [Serializable]
    [Description("")]
    public class TREND_EA : ExpertAdvisorBase   // **Expert Advisor Class name must be the same as the filename
    {
        ...
        public TREND_EA()      // Class constuctor, called by Alveo
        {
        ...
        public TREND_EA(bool optimizing, DateTime time, string path) : this()  // constructor called by simulation
        {
            simulate = true;
            optimize = optimizing;
            simTime = time;
        ...
        internal class HMAobj
        {
            ...
            internal HMAobj(TREND_EA ea, int period, int threshold) : this()   // do HEMA() first
            {
                this.ea = ea;
                Period = period;
