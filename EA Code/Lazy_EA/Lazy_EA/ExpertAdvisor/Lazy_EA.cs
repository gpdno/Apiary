...
namespace Alveo.UserCode
{
    [Serializable]
    [Description("")]
    public class Lazy_EA : ExpertAdvisorBase   // **Expert Advisor Class name must be the same as the filename
    {
        ...
        [Category("SMA")]
        [Description("SMA Period in Bars [ex: 7]")]
        public int SMA50_period; // { get; set; }

        [Category("SMA")]
        [Description("SMA Threshold * 1e-6 [ex: 20]")]
        ...
        [Category("Settings")]
        [Description("Price type to be used for SMA calculations [ex: PRICE_P7]")]
        ...
        public Lazy_EA()      // Class constuctor, called by Alveo
        {
        ...
        public Lazy_EA(bool optimizing, DateTime time, string path) : this()  // constructor called by simulation
        {
            simulate = true;
            optimize = optimizing;
            simTime = time;
